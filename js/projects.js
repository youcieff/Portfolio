const PROJECTS = [
  {
    ...
    num: "01",
    title: "Celia Games",
    subtitle: "Arabic-first multiplayer game collection",
    badge: "React · WebRTC · 2026",
    accent: "#62d7c5",
    accentSoft: "rgba(98, 215, 197, 0.14)",
    overview: "A mobile-first collection of classic games, playable locally or online with friends through PeerJS and WebRTC. Built with an Arabic-first RTL interface, touch-friendly controls, and a polished dark visual style.",
    features: [
      { title: "Peer-to-Peer Multiplayer", desc: "Online matches connect through PeerJS and WebRTC without a custom game server." },
      { title: "A Growing Game Collection", desc: "Includes Sea Battle, Dots & Boxes, Guess the Code, Memory Match, Ultimate Tic-Tac-Toe, Connect 4, Guess the Word, and Tic-Tac-Toe." },
    ...
    highlights: ["Classic games gathered in one responsive platform", "Peer-to-peer online matches without a custom backend", "Arabic RTL experience designed for touch screens"],
